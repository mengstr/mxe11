...
//#										#
//###############################################################################
#ifndef _STM32F411XE_H_
#define _STM32F411XE_H_
#include <stddef.h>
#include <stdint.h>
...
//-----------------------------------------------------------------------------
	struct RCC_tag {
		...
		//+18 reserved
		vuint32_t RESERVED18;

		//+1C reserved
		vuint32_t RESERVED1C;
		...
		//+28 reserved
		vuint32_t RESERVED28;

		//+2C reserved
		vuint32_t RESERVED2C;
		...
		//+38 RCC_AHB3ENR
		vuint32_t RESERVED38;

		//+3C reserved
		vuint32_t RESERVED3C;
		...
		//+58 RCC_AHB3LPENR
		vuint32_t RESERVED58;

		//+5C reserved
		vuint32_t RESERVED5C;
		...
		union {
			...
			struct{
				...
				vuint32_t TIM11LPEN:1;
				  vuint32_t:1;
				vuint32_t SPI5LPEN:1;
				  vuint32_t:11;
			} BIT;	
		} APB2LPENR;

		//+68 reserved
		vuint32_t RESERVED68;

		//+6C reserved
		vuint32_t RESERVED6C;
		...
		//+78 reserved
		vuint32_t RESERVED78;

		//+7C reserved
		vuint32_t RESERVED7C;
...
#define SPI2 (*(volatile struct SPI_tag *) 0x40013800UL)
#define SPI3 (*(volatile struct SPI_tag *) 0x40013C00UL)
...
#define	HAVE_UART6 1
#define	OUTPUT_UART6 send_uart6
#define	UART6_PORT PORT_C
#define	UART6_TX_PIN 6
#define	UART6_RX_PIN 7
#define	HAVE_SPI1 1
